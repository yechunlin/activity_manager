...
**判定**：用户回复"没有""不用""你生成"或未提供链接

**处理**：
1. 从用户整体描述中提取核心信息（活动主题）
2. 生成 10-50 字简要描述 `desc_str`
...
- ✅ 只负责收集信息
- ✅ `size` 固定为 `"818*1404"`
- ✅ `desc_str` 要求：10-50 字，简洁描述主题，不堆砌修饰词
- ❌ 不编造图片链接
